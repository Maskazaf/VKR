...
public class TargetHandler : MonoBehaviour {
    ...
    private TargetFacade CreateTargetFacade(Target target) {
        GameObject targetObject = Instantiate(targetObjectPrefab, targetObjectsParentTransforms[target.PlaceNumber], false);
        targetObject.SetActive(true);
        targetObject.name = $"{target.PlaceNumber} - {target.Name}";
        ...
        targetData.PlaceNumber = target.PlaceNumber;
